...
st.text('Season : '+delivery_df[delivery_df['match_id']==l]['season'].unique())
...
if a!=b:
    ...
    runs=fig.add_trace(go.Bar(x=temp_df['end_of_over'], y=temp_df['runs_after_over'],marker=dict(color='purple')))
