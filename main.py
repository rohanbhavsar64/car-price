...
if part == "Prediction":
    ...
    if a1==b1:
      ...
      fig.add_trace(go.Scatter(x=temp_df['end_of_over'], y=temp_df['win'], mode='lines', name=a1+'Probability', line=dict(color='#00a65a', width=4)))
      fig.add_trace(go.Scatter(x=temp_df['end_of_over'], y=temp_df['lose'], mode='lines', name=b1+'Probability', line=dict(color='red', width=4)))
